...
builder.Host.UseSerilog((context, config) => config
    ...
    .Enrich.WithProperty("servico", "WKR.Consolidacao")
...
namespace WKR.Consolidacao
{
    ...
    /// MS.FluxoDeCaixa já expõe um <c>Program</c> público no namespace
